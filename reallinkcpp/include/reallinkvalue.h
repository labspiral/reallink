#ifndef REALLINKCPP_VALUE_H
#define REALLINKCPP_VALUE_H
...
{
    /**
     * An enum defining the types a reallinkcpp::value may be.
     */
    ...
    //class valuepimpl;
    /**
     * Represents a value to be provided to a RealLink method as a parameter, or returned as a return value.
     */
    class REALLINKCPP_LIB_DLL value
    {
    public:
        /**
